...
class DemofilterAdapter(var mFeedsList: MutableList<FilterData>, val mListener: OnchildCallBack) : RecyclerView.Adapter<DemofilterAdapter.FeedsVH>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, p1: Int): FeedsVH {
        val view = LayoutInflater.from(parent?.context).inflate(R.layout.demofilteritems, parent, false)
        return FeedsVH(view)
    }
